...
This repository contains ai voice agents for business, built using the VideoSDK Agents architecture with a [Pipeline (Cascade Mode)](https://docs.videosdk.live/ai_agents/core-components/pipeline).
...
- A VideoSDK [API Key and Secret Key](https://app.videosdk.live?utm_source=ai-voice-agents-for-business&utm_medium=github-repo-auto&utm_campaign=github-repo-auto)
